...
local Silicon = loadstring(game:HttpGet("https://pastebin.com/raw/DsBH9hnF"))()
...
local Window = WindUI:CreateWindow({
    ...
    Resizable = false,
    SideBarWidth = 200,
    BackgroundImageTransparency = 0.0,
    HideSearchBar = false,
    ...
    User = {
        ...
        Anonymous = false,
        Callback = function()
            print("You clicked the VANTA user button.")
        end,
    },
})
...
WindUI:Notify({Title = "Welcome!", Content = "Enjoy your experience!"})
